...
fn list_functions() {
    ...
    assert_eq!(
        eval!("(cons 1 (list 2))"),
        LispValue::list_from(vector![1.0.into(), 2.0.into(),])
    );
    assert_eq!(
    ...
    assert_eq!(
        ...
        LispValue::list_from(vector![1.0.into(), 2.0.into(), 3.0.into(), 4.0.into(),])
    );
    assert_eq!(
...
fn unquote() {
    ...
    assert_eq!(
        ...
        LispValue::list_from(vector![1.0.into(), 8.0.into(), 3.0.into(),])
    );
